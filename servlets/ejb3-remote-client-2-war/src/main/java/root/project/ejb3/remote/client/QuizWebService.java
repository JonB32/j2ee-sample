...
public class QuizWebService {
	...
	@EJB(mappedName = "ejb:ear-1.0/ejb3-server-war/PlayedQuizzesCounterBean!root.project.ejb3.server.api.IRemotePlayedQuizzesCounter")
	...
	public Response start(@javax.ws.rs.core.Context HttpServletRequest request,
		...
		String earName = "ear-1.0"; //EJB exist in a WAR and not in an EAR.
		...
		// wildf9Lookerup.findSessionBean("ejb:/ejb3-server-war//QuizBean!root.project.ejb3.server.api.ILocalQuiz?stateful");
	...
	@Path("/answer")
	@Produces(MediaType.TEXT_HTML)
	public Response answer(@javax.ws.rs.core.Context HttpServletRequest request, @FormParam("playerAnswer") int playerAnswer) {
